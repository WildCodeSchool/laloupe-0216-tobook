...
<html>
    ...
    <body>
        ...
        <header id="header">
            ...
            <a href="#"><span  class="facebook"><img src="./assets/img/icon-facebook.png" alt="Logo Facebook" title="Suivez-nous sur Facebook" /></span></a>
                    ...
                    <div class="row uniform">
                        ...
                        <div class="12u$">
                            <ul class="actions">
                                ...
                                <li class="chercheblock"><input type="submit" value="Rechercher" class="special"/></li>
                            </ul>
                        </div>
                    </div>
                </form>
